...
public final class OperatorManager
	{
		...
		static private final OperatorManager instance = new OperatorManager();
		...
		public static OperatorManager getOperatorManager() // singleton?
			{
				return instance;
			}

		private void populate() // factory
			{
...
//				}); // much lambda such wow
		...
		public void printInfix(Node root)
			{
				// TODO make it multi-argument accessible
		...
		public int getPriority(String token) // priority
			{
		...
		public boolean getAlignment(String token)
			{
